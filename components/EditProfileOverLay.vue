<template>
    <div  id="EditProfileOverLay" class="fixed flex  justify-center pt-14 md:pt-[105] z-50 top-0left-0 w-full h-full bg-black bg-opacity-50 overflow-auto">
        <div 
        ...
        <div class="absolute flex items-center justify-between w-full p-5 left-0 top-0 border-b border-b-gray-300">
                ...
                <button   @click="$event => $generaleStore.isEditProfileOpen = false" >
            ...
            <div class="h-[calc(500px-200px)]" :class="!uploadedImage ? 'mt-16' : 'mt-[58px]' ">
                <div v-if="!uploadedImage">
                    ...
                    >
                        ...
                        >
                        <div class="mt-3 font-semibold text-[15px] sm:mb-0 mb-1 text-gray-700 sm:w-[160px] sm:text-left text-center">
                            Bio
                        </div>
                            <div class="flex  items-center justify-center sm:mt-6">
                                <div class="sm:w-[60%] w-full mx-w-md">
                                    <textarea 
                                    name=""
                                    id=""
                                    cols="30"
...
watch(()=> userBio.value,()=>{
    if(!userBio.value || userBio.value < 1 ){
        isUpdated.value = false ;
    }
    else {
        isUpdated = true ;
