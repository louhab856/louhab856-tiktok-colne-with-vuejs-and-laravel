<template>
  <div 
    ...
    >
        <div v-if="true" class="lg:w-[calc(100%-540px)] h-full relative">
            <NuxtLink
                href="/"
            ...
            <video 
                ...
                src="/public/the_first_video.mp4" 
            />
        ...
        >
            ...
            <div class="px-8 mt-4 text-sm">this is the post text</div>
                ...
                originale sound - user Name 
                </div>
                <div class="flex items-center px-8 mt-8">
                <div class="pb-4 text-center flex items-center">
                    <div class="rounded-full bg-gray p-2 cursor-pointer">
                        <Icon name="mdi:heart" size="25"/>
                    </div> 
                    <span class="text-xs pl-2 pr-4 text-gray-800 font-semi-bold">
                        123
                    </span>  
                </div>
            ...
            <div  id="comment" class="bg-[#FFFFF] z-0 w-full h-[calc(100% - 273px)] border-t-2 overflow-auto">
                <div class="pt-2"></div>
                    ...
                    <div class="flex items-center relative w-full">
                        ...
                        <div class="ml-14 pt-0.5 w-full">
                            ...
                            <div class="text-[15px] font-light">         
                                lorem ipsum 20221215 001
                                Le lorem ipsum (également appelé faux-texte, lipsum, ou bolo bolo) est, 
                                en imprimerie, une suite de mots sans signification utilisée à titre provisoire 
                                pour calibrer une mise en page, le texte définitif venant remplacer le faux-texte 
