<template>
    ...
    >
      <div class="lg:w-full w-[55px] mx-auto">
        ...
        <MenuItem iconString="Live" colorString="#000000" sizeString="29" />
        <div class="border-b lg:ml-2 mt-2"></div>
        <div class="lg:block hidden text-xs text-gray-600 font-semibold pt-4 pb-4 px-2">
          suggested accounts
        </div>
        ...
        <button class="lg:block hidden text-[#F02C56] pt-1.5 pl-2 text-[13px]">
          See ALL
            ...
            <div class="lg:block hidden text-xs text-gry-600 font-semi-bold pt-4 pb-2 px-2">
                Following account
            </div>
        ...
        <div class="lg:block hidden text-[11px] text-gray-500 ">
            ...
            <div class="pt-4 px-2">© 2024 TikTok (from louhab dev)</div>
        </div>
